...
<script src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.4.14/ace.js" integrity="sha512-6ts6Fu561yzWvD6uwQp3XVYwiWNpWnZ0hdeQrETqtnQiGjTfOS06W76aUDnq51hl1SxXtJaqy7IsZ3oP/uZEg==" crossorigin="anonymous" referrerpolicy="no-referrer">
</script>
...
<link  rel="stylesheet" type="text/css" href="<?= base_url('assets/css/language-markup.css');?>">
<link  rel="stylesheet" type="text/css" href="<?= base_url('assets/css/scrollbar.css');?>">
<link rel="stylesheet" href="<?= base_url('assets/css/visibility.css');?>">
